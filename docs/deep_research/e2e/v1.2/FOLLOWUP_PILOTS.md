...
These are controlled follow-up designs. Cross-paper Attempt-001 and Attempt-002 remain immutable known failures; Cross-paper Attempt-003 and the insufficient-evidence Attempt-002 were each executed once and closed under their scoped acceptance contracts. No additional Provider, Web, Tool or real E2E call is authorized by the current batch.
...
- Artifact: `outputs/deep_research/e2e/v1.2/dr-run-97bad8fbd966fcc8c1f049f3` (retained; closure manifest: [insufficient_evidence_result_manifest.attempt-002.json](insufficient_evidence_result_manifest.attempt-002.json))
...
- Result: `real_insufficient_evidence_abstention_pass_on_obvious_out_of_domain_query`; terminal `insufficient_evidence`, 0 Claims and 0 Citations. The retrieved 3NLKTSIP packaging passage was an explicit false positive and was not used to support the Mars mission question. Hard-negative abstention and semantic correctness remain untested.
