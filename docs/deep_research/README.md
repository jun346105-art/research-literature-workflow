...
17. [GLM E2E Preparation](GLM_DEEP_RESEARCH_E2E_PREP_V1.md)、[controlled pilot](e2e/v1/README.md) 与 [执行记录](sessions/B08E2E-PREP.md)：单 Agent GLM Planner/Writer 的离线准备；未执行真实 E2E。
