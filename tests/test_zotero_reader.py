...
def test_zotero_client_normalizes_windows_file_url(monkeypatch):
    ...
    monkeypatch.setattr(client, "_get_text", lambda path: "file:///C:/Users/GigaByte/Zotero/storage/A/paper.pdf")

    assert client.get_attachment_file_path("A1") == "C:\\Users\\GigaByte\\Zotero\\storage\\A\\paper.pdf"
